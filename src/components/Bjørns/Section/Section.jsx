		...
		<Fragment>
			...
			<section className='section-testimonials '>
				<div className='testimonials-container'>
					...
					<h2 className='heading-secondary'>Listen to what our customers say</h2>
			...
			<section className='section-pricing'>
				...
				<div className='container grid'>
					<aside className='plan-details'>
						Price includes all the extra taxes and charges. You can cancel at any
						time. All three plans includes the follow:
					</aside>
				</div>
				...
				<div className='container grid grid--4-cols'>
					...
					<div className='feature'>
						...
						<p className='feature-text'>
							Pause anytime: Going on vacation? Just pause your subscription, and
							we refund unused days.
						</p>
					</div>
					<div className='feature'>
						<div className='feature-icon'>
				...
				<div className='container'>
					<div className='cta'>
						...
						<div
							...
							role={'img'}
							aria-label={'A Gentle man eating his meal.'}></div>
					</div>
				</div>
			</section>
			<footer>
